...
\begin{itemize}
    ...
    \item{\cventry{August -- September 2016}{Hospitant}{Bayrischer Rundfunk}{Munich}{}{\vspace{3pt}For six weeks I was at \textit{BR Data}, the datajournalistic department of the \textit{Bayrischer Rundfunk}. In this time I wrote a tool for conducting surveys for which I made all major design decisions - such as the software stack - on my own (\textit{see "Project"}).}}
...
\item{\cventry{2007 -- 2015}{Graduation: Allgemeine Hochschulreife (Abitur)}{Oskar-Maria-Graf Gymnasium}{Neufahrn}{}{}}  % arguments 3 to 6 can be left empty
